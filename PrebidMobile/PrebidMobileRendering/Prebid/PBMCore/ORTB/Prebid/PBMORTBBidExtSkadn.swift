...
@objc public class PBMORTBBidExtSkadn: NSObject, PBMJsonCodable {
    ...
    @objc public var fidelities: [PBMORTBSkadnFidelity]?

    /// SKOverlay Support
    @objc public var skoverlay: PBMORTBBidExtSkadnSKOverlay?
